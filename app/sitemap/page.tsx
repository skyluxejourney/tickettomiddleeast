...
export default function SitemapPage() {
  ...
  // 1. Exact arrays taken from the Footer component
  const quickLinks = [
    { name: "Home", href: "/" },
  ...
  // 2. Helper function to generate slug from airline name (Matches Footer logic)
  ...
  // 3. Get top airlines from the airlinesDataMap - limit to 7 for display
      ...
      <div className="min-h-screen bg-white pt-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
          ...
          <nav className="flex items-center gap-2 text-sm mb-6">
            <Link href="/" className="transition-colors" style={{ color: '#131164' }}>
              Home
            </Link>
            <span className="text-[#0c0a4a]/30">›</span>
            <span className="text-[#0c0a4a]/60">Sitemap</span>
          </nav>
          ...
          <div className="w-full">
            ...
            <div className="mb-8">
              ...
              <p className="text-sm leading-relaxed text-justify mt-2" style={{ color: '#0c0a4a99' }}>
                Welcome to the Tickettomiddleeast.com sitemap. This page provides a comprehensive 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              ...
              <div>
                <div className="flex items-center gap-2 mb-4">
                  ...
                  >
                    <LayoutGrid size={16} style={{ color: '#131164' }} />
                  </div>
                  <h2 className="text-lg font-bold" style={{ color: '#0c0a4a' }}>Quick Links</h2>
                </div>
                <ul className="space-y-2.5 border-l-2 pl-4" style={{ borderColor: '#f5edc8' }}>
                  {quickLinks.map((link) => (
                    <li key={link.name}>
                      {link.isModal ? (
                        <a
                          ...
                          className="flex items-center gap-2 text-sm transition-colors duration-200 cursor-pointer group"
                          style={{ color: '#0c0a4a99' }}
                        >
                          <ChevronRight size={14} className="transition-colors flex-shrink-0" style={{ color: '#b7901b' }} />
                          {link.name}
                        </a>
                      ) : link.name === "Home" ? (
                        <a
              ...
              <div>
                <div className="flex items-center gap-2 mb-4">
                  <div 
                    ...
                    style={{ backgroundColor: '#f5edc8' }}
                  >
                    <Plane size={16} style={{ color: '#131164' }} />
                  </div>
                  <h2 className="text-lg font-bold" style={{ color: '#0c0a4a' }}>Top Airlines</h2>
                </div>
                <ul className="space-y-2.5 border-l-2 pl-4" style={{ borderColor: '#f5edc8' }}>
              ...
              <div className="md:col-span-2 lg:col-span-1">
                <div className="flex items-center gap-2 mb-4">
                  <div 
                    ...
                    style={{ backgroundColor: '#f5edc8' }}
                  >
                    <Scale size={16} style={{ color: '#131164' }} />
                  </div>
                  <h2 className="text-lg font-bold" style={{ color: '#0c0a4a' }}>Legal & Policies</h2>
                </div>
                <ul className="space-y-2.5 border-l-2 pl-4" style={{ borderColor: '#f5edc8' }}>
                  {legalLinks.map((link) => (
                    <li key={link.name}>
